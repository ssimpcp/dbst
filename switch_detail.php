...
<div class="well">
<fieldset>  
<form class="form-horizontal" method="post" enctype="multipart/form-data" action="add_detail.php">
  ...
  <table>
		    	...
		    	<option>자산 선택</option>
		    	<?php
				$query = "SELECT asset.asset_num FROM asset, total_asset WHERE asset.asset_num = total_asset.asset_num AND total_asset.un_n > 0";
...
<script>
	function setMaxNum() {
		...
		if(x) {
			...
			xmlhttp.send("category=switch&asset_num="+index);
		}
	}
</script>
</body></html>
