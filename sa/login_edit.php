...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
   	...
   	<div class="jumbotrom text-center">
      	<form method="post" action="identify_new_pw.php">
		<br/>	
		<label>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; NEW PW : <input type="password" name="newPASS" /></label>
		<br/>
		<label>AGAIN INPUT : <input type="password" name="newPASS_again" />&nbsp; &nbsp;</label>
		<br/>
