                ...
                <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
							...
							<th>-</th>
                                        ...
                                        <tbody>
					<?php
					  $query = "SELECT service_name FROM service WHERE service_name <> 'FREE' ORDER BY service_name";
					  ...
					  while($result = $stmt->fetch(PDO::FETCH_NUM)){
					    ...
					    print '<td rowspan="2"><a type="button" class="btn btn-default" onclick="deleteConfirm(\''.$result[0].'\')">delete</a></td>';
					    print '</tr>';
...
function deleteConfirm(x){
	...
	if(r == true)
	{
		location.replace("del_service.php?service_name=" + x);
	}
}
</script>
</body>
